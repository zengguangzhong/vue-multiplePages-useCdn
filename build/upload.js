...
// 阿里OSS上传
const client = new OSS(cdnConfig.aLiOss)
...
qiniuConfig.zone = qiniu.zone[cdnConfig.qiNiuCdn.zone]
...
uploadAll(publicPath, cdnConfig.uploadPath.prefix)
